      ...
      <div className="flex-shrink-0 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-primary-teal hover:bg-primary-teal/90 text-white rounded-md transition-colors text-sm"
          >
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            ...
            <div className="flex items-center space-x-3 mt-4">
              <button
                ...
                className="px-4 py-2 bg-primary-teal hover:bg-primary-teal/90 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-md transition-colors"
              >
                Add Provider
              </button>
              <button
                  ...
                  <div className="p-6 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex items-center justify-end space-x-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
                      <button
                        ...
                        className="px-6 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors focus:ring-2 focus:ring-primary-teal"
                      >
                        Cancel
                      </button>
                      <button
                        onClick={() => handleSaveProvider(provider.provider)}
                        className="flex items-center space-x-2 px-6 py-2 bg-primary-teal hover:bg-primary-teal/90 text-white rounded-md transition-colors focus:ring-2 focus:ring-primary-teal"
                      >
                ...
                <div className="border-t border-gray-200 dark:border-gray-700">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="flex items-center space-x-1 px-3 py-1 bg-primary-teal hover:bg-primary-teal/90 text-white rounded-md transition-colors text-sm"
                      >
                  ...
                  {isExpanded && (
                    <div className="border-t border-gray-200 dark:border-gray-700">
                      {/* Add New Model Form */}
                      {showNewModelForm && (
                        <div className="p-4 bg-primary-teal/10 dark:bg-primary-teal/20 border-b border-gray-200 dark:border-gray-700">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-primary-teal focus:border-primary-teal dark:bg-gray-700 dark:text-white text-sm"
                              />
                            </div>
                            <div>
                              <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
                              ...
                              <input
                                type="text"
                                value={
                                  newModelForm[provider.provider]
                                    ?.displayName || ""
                                }
                                onChange={(e) =>
                                  setNewModelForm((prev) => ({
                          ...
                          <div className="flex items-center space-x-3 mt-3">
                            <button
                              ...
                              className="px-4 py-2 bg-primary-teal hover:bg-primary-teal/90 disabled:bg-gray-400 disabled:cursor-not-allowed text-white rounded-md transition-colors text-sm"
                            >
                              Add Model
                            </button>
                            <button
        ...
        {allProviders.length === 0 && (
          <div className="text-center py-12">
            ...
            <button
              ...
              className="flex items-center space-x-2 mx-auto px-4 py-2 bg-primary-teal hover:bg-primary-teal/90 text-white rounded-md transition-colors"
            >
              <Plus className="w-4 h-4" />
              <span>Add Provider</span>
            </button>
