  ...
  return (
    ...
    >
      ...
      <div aria-live="polite" aria-atomic="true" className="sr-only">
        {isLoading && "AI models are analyzing your request..."}
      </div>
      {/* Messages Container */}
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
        {messages.length === 0 && !sessionId ? (
          // Welcome Screen - Improved without duplicate logo
          <div className="flex items-center justify-center h-full">
            <div className="text-center px-4 max-w-2xl">
              <h2 className="text-2xl md:text-3xl font-bold text-primary-cyan mb-4">
                Start Your AI Consensus Session
              </h2>
              ...
              {/* Quick Start Tips */}
              <div className="text-left bg-bg-dark-secondary rounded-lg p-4 mb-6 border border-primary-teal/20">
                <h3 className="text-primary-teal font-semibold mb-3">
                  💡 Quick Start Tips:
                </h3>
                <ul className="text-gray-400 text-sm space-y-2">
                  <li>• Configure your AI models in the sidebar</li>
                  <li>• Upload documents for context-aware discussions</li>
                  <li>• Enable debate mode to see model reasoning</li>
                  <li>• Create approval workflows for document changes</li>
                </ul>
              </div>
                ...
                <div className="text-sm text-gray-500">
                  {modelSelection.selectedModels.length > 0 ? (
                    <span className="text-primary-green">
                      ✓ {modelSelection.selectedModels.length} AI model
                      {modelSelection.selectedModels.length > 1 ? "s" : ""}{" "}
                      ready
                    </span>
                  ) : (
                    <span className="text-orange-400">
                      ⚠ No AI models selected - configure models in the sidebar
                    </span>
                  )}
                </div>
              )}
